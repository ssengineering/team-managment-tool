...
require_once('checkPermission.php'); //require_onced for checking permissions
###################################Template/Style Includes###################################
//require_once('php_header.php'); // php_header is require_onced to give your website variable and safe email address
//require_once('templates_lev2.php'); // templates displays the top section of the page
//require_once('templates_all_popup.php'); // templates_all_popup displays the menu system
//require_once('css.php'); //Contains CSS
require_once('simpleHeader.php'); //Simple header version of the template
require_once('calendar.php'); //Used to print out the javascript calendar

//require_once('special_feature.php'); // displays the special articles and middle section of the homepage
//require_once('template_footer_lev2.php'); // displays the footer content - you may want to put a web analytics tool here and in template_footer_lev2
