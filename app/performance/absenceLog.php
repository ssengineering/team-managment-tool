...
$readPermission = can("read", "86755385-4a09-45ce-81b9-049b660210df");//performanceSummary resource
...
<button onclick="window.open('absence.php','_blank')" >Submit a New Absence Report</button>
<?php } ?>
<br/><br/>
<form name="absence" method="post" id='absence'>
<table>
	<tr>
		<th>Employee</th>
		<th>Start Date</th>
