...
<button onclick="window.open('policyReminder.php','_blank')"> Submit a New Policy Reminder</button>
<?php } ?>
<br/><br/>
<form name="policy" method="post" id='policy'>
<table>
	<tr>
		<th>Employee</th>
		<th>Start Date</th>
