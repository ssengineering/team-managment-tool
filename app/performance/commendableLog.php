...
<div align='center'>
<h1>Commendable Performances</h1>
...
<button onclick="window.open('commendablePerformance.php','_blank')" >Submit a New Commendable Performance</button>
<?php } ?>
<br/><br/>
<form name="commendable" method="post" id='commendable'>
<table>
	<tr>
		<th>Employee</th>
		<th>Start Date</th>
