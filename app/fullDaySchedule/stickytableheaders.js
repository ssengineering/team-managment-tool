...
(function ($) {
	$.StickyTableHeaders = function (el, options) {
		...
		// Modified by Luis on july 17th.
		// I changed the default fixedOffset (before it was 0) so that it would give place to the scrolling menu.
		var newDefault = $("#primary-nav").height();

	$.StickyTableHeaders.defaultOptions = {
		 
		fixedOffset: newDefault
	};
