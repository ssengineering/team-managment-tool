...
*/
	...
	//Declare variables
	//$startDate = date('Y-m-d',strtotime("-1 year"));//TODO - I think Brad was using this for testing to see past trades.  Delete when moving to stg and prod
	//$startDate = date('Y-m-d');
	//$curDate = date('Y-m-d',strtotime('-3 day'));
...
<div id='availableTrades' align='center' style='padding: 10px;'>
...
<div id='hourRequests' align='center' style='padding: 10px;'>
